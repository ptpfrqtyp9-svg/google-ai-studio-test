...
public struct ImageChannelsSheet: View {
    ...
    // Channel 4 / Featured: Curated SF Symbols Library
    @State private var isSFSymbolsLibraryPresented: Bool = false
    ...
    public var body: some View {
        NavigationView {
            ZStack {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 24) {
                        ...
                        // FEATURED CHANNEL: Curated SF Symbols Library (Hundreds of Traceable Symbols)
                        VStack(alignment: .leading, spacing: 10) {
                            HStack {
                                Label("Curated SF Symbols Matrix", systemImage: "sparkles")
                            ...
                            Button(action: {
                                isSFSymbolsLibraryPresented = true
                            }) {
                                HStack(spacing: 14) {
                                    ZStack {
                                    ...
                                    VStack(alignment: .leading, spacing: 3) {
                                        HStack(spacing: 6) {
                                            Text("Browse SF Symbols Library")
                        ...
                        // CHANNEL 1: Built-In Vector Library (15 Shapes)
                        VStack(alignment: .leading, spacing: 14) {
                            HStack {
                                Label("Built-In Vector Library", systemImage: "sparkles.rectangle.stack.fill")
                                    .font(.system(size: 14, weight: .bold))
                                    .foregroundColor(.cyan)
                                Spacer()
            ...
            .sheet(isPresented: $isSFSymbolsLibraryPresented) {
